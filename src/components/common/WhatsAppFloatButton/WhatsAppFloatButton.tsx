...
import { getWhatsAppHref } from '@/lib/marketing-links';
...
export function WhatsAppFloatButton({ bottom = 20 }: WhatsAppFloatButtonProps) {
  const locale = useLocale();
  const href = getWhatsAppHref(locale);
